...
class View:
    ...
    def load_interface(self):
        ...
        # Riga 1
        self.dd_year = ft.Dropdown(label="Anno", width=200, on_change=self.controller.on_change_anno)
        self.dd_shape = ft.Dropdown(label="Forma", width=200,on_change=self.controller.on_change_forma)
